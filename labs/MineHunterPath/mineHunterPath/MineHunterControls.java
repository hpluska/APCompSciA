...
public class MineHunterControls extends JPanel {
    ...
    public MineHunterControls(ActionListener a){
        ...
        showPathButton.addActionListener(a);
        add(showPathButton);
        
        JButton showMinesButton = new JButton();
        showMinesButton.setText("Show Mines");
        showMinesButton.addActionListener(a);
        add(showMinesButton);
    }
    ...
    public int getButtonAction(JButton s){
        ...
        if(s.getText().equals("Reset")){
            return 0;
        }else if(s.getText().equals("Show Path")){
            return 1;
        }else if(s.getText().equals("Show Mines")){
            return 2;
        }
        return 0;
    }
